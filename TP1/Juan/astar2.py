...
class Spot:
	...
	def update_neighbors1(self, grid):
		self.neighbors1 = []

		#Si ambos caminos se tocan, el segundo agentes no puede pasar por el camino del primer agente, por lo que esos bloques son barreras
...
def algorithm1(draw, grid, start1, end1):
    count = 0
    open_set = PriorityQueue()
